...
@Component({
  selector: 'app-setor-concurso-prova-lista',
  templateUrl: './setor-concurso-prova-lista.component.html',
  styleUrls: ['./setor-concurso-prova-lista.component.css']
})
export class SetorConcursoProvaListaComponent implements OnInit {
